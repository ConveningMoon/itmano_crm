...
// Control de acceso de Newsletters — aislado igual que canUseStudio. Úsalo en
// la página Y en CADA server action: una server action es un endpoint HTTP, la
// ruta no es la única puerta.
//
